...
txtl_adddna(tube3, ...
    'p70(50)', 'rbs(20)', 'sigma28(600)', 20, 'linear');
txtl_adddna(tube3, ...
    'p28_ptet(150)', 'rbs(20)', 'deGFP(1000)-lva-terminator', 20, 'linear');
txtl_adddna(tube3, ...
...
txtl_adddna(tube4, ...
    'p28(50)', 'rbs(20)', 'tetR(600)', 15, 'linear');
txtl_adddna(tube4, ...
    'p70(50)', 'rbs(20)', 'sigma28(600)',20, 'linear');
txtl_adddna(tube4, ...
    'p28_ptet(150)', 'rbs(20)', 'deGFP(1000)-lva-terminator', 20, 'linear');
...
% Mix the contents of the individual tubes
 well_a1 = txtl_combine([tube1, tube2, tube3], [22, 18, 1]);
...
% set up well_b1
well_b1 = txtl_combine([tube1, tube2, tube4], [22, 18, 1]);
